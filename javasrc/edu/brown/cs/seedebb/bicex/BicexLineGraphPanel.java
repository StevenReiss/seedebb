...
private class LineFlowGraph extends JPanel {
   ...
   void setCurrentNode(Node n) {
	 ...
	 BoardColors.setColors(current_node.getComponent(),DEFAULT_COLOR_PROP);
       }
      current_node = n;
      if (current_node != null) {
	 BoardColors.setColors(current_node.getComponent(),CURRENT_COLOR_PROP);
...
private class Node extends PetalNodeDefault {
   ...
   Node(int line,PetalNodeShape shape) {
      ...
      line_number = line;
      BoardColors.setColors(getComponent(),DEFAULT_COLOR_PROP);
    }
